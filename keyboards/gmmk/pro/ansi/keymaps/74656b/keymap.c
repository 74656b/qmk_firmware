...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [_FL_RGB] = LAYOUT(
        ...
        _______,          _______, _______, _______, _______, _______, _______, _______, _______, MO(3),   _______,          _______, RGB_MOD,  _______,
        _______, _______, _______,                            _______,                            MO(2),   _______, KC_KP_0, RGB_SPD, RGB_RMOD, RGB_SPI
    ),
