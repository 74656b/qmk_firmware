...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [_FL_RGB] = LAYOUT(
        RGB_TOG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PAUSE, RESET,             _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MYCM,           _______,
        _______, _______, RGB_MOD, _______, _______, _______, _______, _______, _______, _______, RGB_HUI, RGB_SAI, RGB_VAI, _______,           _______,
        ...
        KC_LCTL, _______, KC_LALT,                            _______,                            MO(2),   _______, KC_KP_0, _______, _______, _______
    ),
